...
return [
    ...
    */
    ...
    | cache/log) — it is never the source of truth for production media. 'r2' is
    | the default disk so every upload feature writes to R2 unless a Temp/ path
    ...
    */
    ...
    'disks' => [
        ...
        // Cloudflare R2 (S3-compatible). Default disk for all production media:
        // product photos, logos, banners, proof-of-transfer, invoices, import/export.
        'r2' => [
            'driver' => 's3',
